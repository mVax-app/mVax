...
import com.mvax.R;
import com.mvax.auth.modals.ChangeRoleModal;
import com.mvax.auth.modals.DeleteUserModal;
import com.mvax.auth.modals.RoleInfoModal;
...
public class ManageUsersAdapter extends RecyclerView.Adapter<ManageUsersAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.role.setText(user.getRole().getResourceId());
